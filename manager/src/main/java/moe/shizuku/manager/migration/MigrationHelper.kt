package moe.shizuku.manager.migration
...
/**
 * Detects and migrates settings from the old `rikka.shizuku.privileged.api` package
 * to the current `moe.shizuku.privileged.api` package.
 *
...
object MigrationHelper {
    ...
    const val OLD_PACKAGE = "rikka.shizuku.privileged.api"
