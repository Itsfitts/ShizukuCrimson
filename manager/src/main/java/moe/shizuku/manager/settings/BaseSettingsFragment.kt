...
import moe.shizuku.manager.utils.HapticUtils
import moe.shizuku.manager.utils.IconStyleHelper
...
abstract class BaseSettingsFragment : PreferenceFragmentCompat() {
    ...
    protected class SettingsItemDecoration(context: Context) : moe.shizuku.manager.widget.M3ECardItemDecoration(context) {
