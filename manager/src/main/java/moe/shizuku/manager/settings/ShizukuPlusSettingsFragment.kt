...
import moe.shizuku.manager.security.BiometricLock
...
class ShizukuPlusSettingsFragment : BaseSettingsFragment() {
    ...
    private fun showDhizukuSetupDialog(ctx: Context) {
        // applicationId (moe.shizuku.privileged.api) differs from namespace (moe.shizuku.manager),
        ...
        val command = "adb shell dpm set-device-owner " +
            "${ctx.packageName}/moe.shizuku.manager.admin.DhizukuAdminReceiver"
