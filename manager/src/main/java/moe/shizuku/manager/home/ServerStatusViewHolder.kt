...
class ServerStatusViewHolder(private val binding: HomeServerStatusBinding, root: View) :
    ...
    override fun onBind() {
        ...
        sentryButton.visibility = if (moe.shizuku.manager.ShizukuSettings.isSentryLimitReached()) View.VISIBLE else View.GONE
        sentryButton.setOnClickListener {
            com.google.android.material.dialog.MaterialAlertDialogBuilder(context)
                ...
                .setNeutralButton(R.string.update_view_on_github) { _, _ ->
                    moe.shizuku.manager.utils.CustomTabsHelper.launchUrlOrCopy(context, "https://github.com/thejaustin/ShizukuPlus/issues")
                }
                .show()
        }
        ...
        logButton.setOnClickListener {
            ...
            activity.startWithSceneTransition(
                android.content.Intent(activity, moe.shizuku.manager.settings.ActivityLogActivity::class.java),
        ...
        if (rikka.shizuku.Shizuku.isPreV11() || moe.shizuku.manager.utils.ShizukuStateMachine.get() == moe.shizuku.manager.utils.ShizukuStateMachine.State.STARTING) {
