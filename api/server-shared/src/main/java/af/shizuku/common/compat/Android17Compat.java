        ...
        try {
            ...
            try {
                ...
                if (sCheckPermissionUidMethod != null) {
                    ...
                    if (paramTypes.length == 3 && paramTypes[0] == int.class && paramTypes[1] == String.class) {
                        if (paramTypes[2] == int.class) {
                            return (int) sCheckPermissionUidMethod.invoke(pm, uid, permissionName, 0);
                        } else if (paramTypes[2] == String.class) {
                            return (int) sCheckPermissionUidMethod.invoke(pm, uid, permissionName, "default");
                        }
